...
export default class PreferenceScreen extends Component {
    ...
    constructor(props){
        ...
        this.state={
            preference:menuDetailedData[this.props.route.params.id].preferenceData,
            required:menuDetailedData[this.props.route.params.id].required,
            minimum_quatity:menuDetailedData[this.props.route.params.id].minimum_quatity,
            counter:menuDetailedData[this.props.route.params.id].counter
    ...
    render() {
        ...
        const {meal,details,price}=menuDetailedData[id]
            ...
            <View style={styles.container}>
                            ...
                            this.state.preference.map(item=>
                                <View key={item.id}>
                                    <View style={styles.view7}>
                                        <Text style={styles.text8}>{menuDetailedData[id].preferenceTitle[this.state.preference.indexOf(item)]}</Text>
                                        {
                ...
                <View style={styles.view17}>
                    <View style={styles.view18}>
                        <Text style={styles.text10}>Add 1 to Cart R67.43</Text>
                    </View>
                </View>
            </View>
        )
